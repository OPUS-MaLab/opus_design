...
from utils.network.pre_trained_embedding.model.LinearModule import Linear
...
class Embedding(tf.Module):
    def __init__(self, config, name='Embedding'):
        ...
        self.pre_linear_1d = Linear(c_m, num_input=37+512, name='preprocess_1d')

        self.pre_linear_left = Linear(c_p, num_input=37+512, name='left_single')
        self.pre_linear_right = Linear(c_p, num_input=37+512, name='right_single')
